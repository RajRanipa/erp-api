...
export const DEFAULT_ROLE_TEMPLATES = Object.freeze([
  ...
  },
  {
    ...
    permissions: [
      ...
      'crm:read',
      'warehouse:read',
      ...byPrefix('items:', 'parameters:', 'inventory:', 'warehouses:', 'parties:', 'campaigns:', 'batches:', 'production:'),
      'users:read',
      'users:invite:read',
      'users:invite:create',
      'users:invite:resend',
  ...
  },
  {
    ...
    rank: 30,
    isSystem: true,
    permissions: ['dashboard:read', 'items:read', 'inventory:read', 'parties:read'],
  },
  {
    key: 'viewer',
    name: 'Viewer',
    ...
    rank: 10,
    isSystem: true,
    permissions: ['dashboard:read', 'items:read', 'inventory:read', 'parties:read', 'reports:view'],
  },
]);
