...
const inventoryBalanceV2Schema = new Schema({
...
inventoryBalanceV2Schema.index(
  {
    companyId: 1,
    itemId: 1,
    warehouseId: 1,
...
export default mongoose.models.InventoryBalanceV2
  || mongoose.model('InventoryBalanceV2', inventoryBalanceV2Schema);
