...
router.get('/by-role', roleAuth('permissions:read'), getRolePermissionsbyRole);

router.get('/role/:role', roleAuth('users:permissions:read'), getRolePermissions);
...
router.post('/role/remove', roleAuth('users:permissions:remove'), removeRolePermissions);
